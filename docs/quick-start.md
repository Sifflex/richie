...
If you need to go to deeper about integration between Richie and OpenEdx, you should read [the 
advanced guide](lms-connection.md#connecting-richie-and-openedx-over-tls)
to connect Richie to OpenEdx over TLS.
